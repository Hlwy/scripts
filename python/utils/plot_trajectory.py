...
ap.add_argument("--datalog", "-d", type=str, metavar='FILE', default='datalog-Mon_May_21_22-26-37_2018-0.txt', help="Name of video file to parse")
...
trajInputs = np.genfromtxt(newTrajPath, delimiter=' ')
