...
# Build tools:
sudo apt install -y build-essential git cmake pkg-config unzip wget
...
# Python:
sudo apt install -y python2.7-dev python-dev python-tk python-numpy python-gunicorn python3-dev python3-tk python3-numpy
